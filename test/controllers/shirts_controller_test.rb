...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { amount: @shirt.amount, color: @shirt.color, neck: @shirt.neck, size: @shirt.size, total: @shirt.total }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { amount: @shirt.amount, color: @shirt.color, neck: @shirt.neck, size: @shirt.size, total: @shirt.total }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
